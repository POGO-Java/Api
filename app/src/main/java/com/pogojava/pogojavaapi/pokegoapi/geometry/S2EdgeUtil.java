...
package com.pogojava.pogojavaapi.pokegoapi.geometry;
...
public strictfp class S2EdgeUtil {
  ...
  public static S2Point getIntersection(S2Point a0, S2Point a1, S2Point b0, S2Point b1) {
	...
	if (!(robustCrossing(a0, a1, b0, b1) > 0)) throw new IllegalStateException("Input edges a0a1 and b0b1 muct have a true robustCrossing.");
  ...
  public static double getDistanceFraction(S2Point x, S2Point a0, S2Point a1) {
   // Preconditions.checkArgument(!a0.equals(a1));
	  if(a0.equals(a1)) throw new IllegalArgumentException();
  ...
  public static S1Angle getDistance(S2Point x, S2Point a, S2Point b, S2Point aCrossB) {
    ...
    //Preconditions.checkArgument(S2.isUnitLength(b));
	  if(!S2.isUnitLength(x)) throw new IllegalArgumentException();
	  if(!S2.isUnitLength(a)) throw new IllegalArgumentException();
	  if(!S2.isUnitLength(b)) throw new IllegalArgumentException();
