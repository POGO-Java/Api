...
package com.pogojava.pogojavaapi.pokegoapi.api.map.pokemon;


import android.util.Log;

import com.pogojava.pogojavaapi.pokegoapi.api.PokemonGo;
import com.pogojava.pogojavaapi.pokegoapi.api.map.pokemon.encounter.DiskEncounterResult;
import com.pogojava.pogojavaapi.pokegoapi.api.map.pokemon.encounter.EncounterResult;
import com.pogojava.pogojavaapi.pokegoapi.api.map.pokemon.encounter.NormalEncounterResult;
import com.pogojava.pogojavaapi.pokegoapi.api.settings.AsyncCatchOptions;
import com.pogojava.pogojavaapi.pokegoapi.exceptions.EncounterFailedException;
...
public class CatchablePokemon implements MapPoint {
	...
	private PokeCallback<EncounterResult> encounterNormalPokemon(PokeCallback<EncounterResult> callback) {
		api.setLatitude(getLatitude());
		api.setLongitude(getLongitude());
		...
		if (options.getNumThrows() > trialNum) {
			...
			wrappedCallback = new PokeCallback<CatchResult>() {
				...
				public void onResponse(CatchResult result) {
					...
					try {
						Thread.sleep(options.getSleepTime());
